...
def multiply_list(lst):
    ...
    if len(lst) == 1:
        ...
        #approach base case
        return lst.pop() * multiply_list(lst)
...
# da d ad
# d1->a2->d3->a4->d5 .pop(0)
# d5->a4->d3->a2->d1   //reach base case; return; stack

#reverse list; compare to orginal list
def fold_paper(width, height, folds):
    ...
    #here watch out what you are returning; if you get a whole # and returning decimal
    #couldn't do a counter here because counter kept getting reset to n = 0 for example
    #next best thing is to check if width > height
    #outside of that I had the problem 95% right with logic and written
